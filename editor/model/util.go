...
func indexLineFile(filename string, update func(offset int, line []byte), done func()) {
	defer done()
...
// indexLineFileParallel - code generated by chatgpt - similar to indexLineFile but load file in parallel
func indexLineFileParallel(filename string, update func(offset int, line []byte), done func()) {
	defer done()
